...
static int Player_actor_Set_Item_net_catch_request_table(ACTOR*, GAME*, runtime_id_t, s8, const xyz_t*, f32);
static f32 Player_actor_Get_Item_net_catch_swing_timer(ACTOR*, GAME*);
static int Player_actor_Set_Item_net_catch_request_force(ACTOR*, GAME*, runtime_id_t, s8);
...
static runtime_id_t Player_actor_Get_item_net_catch_label(ACTOR*);
static int Player_actor_Change_item_net_catch_label(ACTOR*, runtime_id_t, s8);
...
static int Player_actor_request_main_notice_mosquito(GAME* game, runtime_id_t label, int prio);
