...
/* @BUG - field_info was not freed */
    ...
    for (i = 0; i < field_info->bg_num; i++) {
        ...
        field_info->bg_display_list_p[i] =
            (u8*)ALIGN_NEXT((uintptr_t)field_info->bg_display_list_p[i], (uintptr_t)16);
    }
...
// Aus version added NULL check
        ...
        if (gamealloc_data_p != NULL) {
            fg_data_p = (mFM_fg_data_c*)(ALIGN_NEXT((uintptr_t)gamealloc_data_p, (uintptr_t)32));
        }
#else
        fg_data_p = (mFM_fg_data_c*)(ALIGN_NEXT((uintptr_t)gamealloc_data_p, (uintptr_t)32));
#endif
...
extern void mFM_SetIslandNpcRoomData(GAME* game, int malloc_flag) {
    ...
    if (malloc_flag == TRUE) {
        ...
        fgnpc_data_p = (mFM_fg_data_c*)(ALIGN_NEXT((uintptr_t)gamealloc_data_p, (uintptr_t)32));
    } else {
        fgnpc_data_p = (mFM_fg_data_c*)zelda_malloc_align(fgnpc_size_align, 32);
    }
