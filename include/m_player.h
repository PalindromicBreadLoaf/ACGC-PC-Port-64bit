...
struct player_actor_s {
    ...
    /* 0x0E70 */ runtime_id_t item_net_catch_label;
    /* 0x0E74 */ s8 item_net_catch_type;
    /* 0x0E75 */ s8 item_net_has_catch;
    /* 0x0E78 */ runtime_id_t item_net_catch_label_request_table[mPlayer_NET_CATCH_TABLE_COUNT];
    ...
    /* 0x0F24 */ runtime_id_t item_net_catch_label_request_force;
    ...
    /* 0x1220 */ runtime_id_t able_force_speak_label;
    ...
    /* 0x1304 */ int (*Set_Item_net_catch_request_table_proc)(ACTOR*, GAME*, runtime_id_t, s8, const xyz_t*, f32);
    /* 0x1308 */ f32 (*Get_Item_net_catch_swing_timer_proc)(ACTOR*, GAME*);
    /* 0x130C */ int (*Set_Item_net_catch_request_force_proc)(ACTOR*, GAME*, runtime_id_t, s8);
    ...
    /* 0x1334 */ runtime_id_t (*Get_item_net_catch_label_proc)(ACTOR*);
    /* 0x1338 */ int (*Change_item_net_catch_label_proc)(ACTOR*, runtime_id_t, s8);
