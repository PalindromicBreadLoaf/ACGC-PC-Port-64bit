...
extern void Na_OngenPos(runtime_id_t id, u8 index, u16 angle, f32 distance);
...
extern void Na_RhythmPos(runtime_id_t index, u8 unused, u16 angle, f32 distance);
...
extern void Na_KishaStatusLevel(f32 speed, runtime_id_t ongenNum1, u16 angle1, f32 distance1,
                                runtime_id_t ongenNum2, u16 angle2, f32 distance2);
...
extern u8 Na_RoomIncectPos(runtime_id_t insectID, u8 index, u16 angle, f32 distance);
extern void Na_FurnitureInstPos(runtime_id_t id, u16 angle, f32 distance);
